...
class Testlink_XML_RPC_API_Tests(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._testMethodDoc = "Testlink_XML_RPC_API: " +\
                               str(self._testMethodDoc)

    def setUp(self):
        """Needed to connect to a mocked Server endpoint in each test"""
        self._patcher = patch('xmlrpclib.ServerProxy',\
                              new=ServerMock, spec=True)
    ...
    def test_query(self):
        ...
        self._mock_server.error = Mock(return_value=\
                                [{'code':1337, 'message':'SPAM!'}])
        ...
        self._mock_server.passed.assert_called_with(\
            dict(a=data['a'], b=data['b'], c=data['c'], devKey=None)\
        )
    ...
    def test_create_risk(self, query):
        ...
        query.assert_called_with('tl.createRisk',\
                        devKey=None,\
                        **test_data\
                    )
    ...
    def test_assign_risks(self, query):
        ...
        query.assert_called_with('tl.assignRisks',\
                        devKey=None,\
                        **test_data\
                    )
